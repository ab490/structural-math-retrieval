...
#SBATCH --output=../logs/deberta_eval_%j.out
#SBATCH --error=../logs/deberta_eval_%j.err
...
MODELS=("microsoft/deberta-v2-xxlarge" "microsoft/deberta-v3-large")
